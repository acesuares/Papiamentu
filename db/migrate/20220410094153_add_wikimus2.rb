class AddWikimus2 < ActiveRecord::Migration[6.0]
  def up
    ...
    # image	pap_cw	artist	license	wikidata_url
      ...
      if word.nil?
        ...
        unless image_filename && File.exists?("#{photo_dir}/#{image_filename}")
          ...
          picture = word.pictures.create( name: row["pap_cw"],
                                ...
                                license: License.find_by_name(row["license"]) || License.first,
                              )
