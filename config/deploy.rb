...
set :linked_dirs, fetch(:linked_dirs, [])
  .push("log", "tmp/pids", "tmp/cache", "tmp/sockets", "public/system", "vendor/bundle", "public/uploads")
...
namespace :rvm1 do # https://github.com/rvm/rvm1-capistrano3/issues/45
  ...
  task :install_bundler do
    on release_roles :all do
      ...
      execute "cd #{release_path} && #{fetch(:rvm1_auto_script_path)}/rvm-auto.sh . gem uninstall --all mini_racer libv8-node"
