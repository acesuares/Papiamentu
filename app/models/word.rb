...
class Word < ApplicationRecord
  ...
  scope :is_construction, -> { where(is_construction: 2) }
  ...
  def inline_forms_attribute_list
    @inline_forms_attribute_list ||= [
      ...
      [ :description_pap_aw , "description_pap_aw", :text_area_without_ckeditor ],
      [ :comment , "description_nl", :text_area_without_ckeditor ],
      [ :comment , "description_en", :text_area_without_ckeditor ],
      [ :comment , "description_es", :text_area_without_ckeditor ],
